...
import { Wallet, Eye, EyeOff, Send, ShoppingBag } from 'lucide-react'
            ...
            <div style={{ height: 6, background: 'var(--border)', borderRadius: 3, overflow: 'hidden' }}>
              <motion.div
                ...
                style={{
                  ...
                  background: weeklyPct > 80 ? 'var(--red)' : weeklyPct > 60 ? 'var(--yellow)' : 'var(--accent)'
                }}
              />
            </div>
          ...
          <div className="card" style={{ padding: 20 }}>
            ...
            <div style={{ height: 6, background: 'var(--border)', borderRadius: 3, overflow: 'hidden' }}>
              <motion.div
                ...
                style={{
                  height: '100%', borderRadius: 3,
                  background: monthlyPct > 80 ? 'var(--red)' : monthlyPct > 60 ? 'var(--yellow)' : 'var(--accent)'
                }}
              />
            </div>
